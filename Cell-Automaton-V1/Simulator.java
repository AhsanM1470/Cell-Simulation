...
/**
 * A cell Life (Game of Life) simulator, first described by British mathematician John Horton Conway in 1970.
 *
    ...
    private void populate() {
        ...
        for (int row = 0; row < field.getDepth(); row++) {
            for (int col = 0; col < field.getWidth(); col++) {
                ...
                else if(randResult > 0.23 && randResult <= 0.26){
                    WhiteBloodCell white = new WhiteBloodCell(this, field, location, Color.PINK);
                    cells.add(white);
                }

                else if (randResult > 0.26 && randResult <= 0.261){
